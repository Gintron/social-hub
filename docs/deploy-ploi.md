...
`pages_read_engagement`, `instagram_basic`, `instagram_content_publish` i njezin id upiši u
`META_LOGIN_CONFIG_ID`. Bez konfiguracije hub šalje klasičan `scope` popis iz `config/meta.php`.
