...
return [
    ...
    'kinds/hook-square' => ['view' => 'templates.kinds.hook', 'width' => 1080, 'height' => 1080, 'kinds' => ['job', 'deal', 'article', 'event', 'generic', 'comparison'], 'label' => 'Udica — kvadrat'],
    'kinds/hook-portrait' => ['view' => 'templates.kinds.hook', 'width' => 1080, 'height' => 1350, 'kinds' => ['job', 'deal', 'article', 'event', 'generic', 'comparison'], 'label' => 'Udica — portret'],
    'kinds/hook-story' => ['view' => 'templates.kinds.hook', 'width' => 1080, 'height' => 1920, 'kinds' => ['job', 'deal', 'article', 'event', 'generic', 'comparison'], 'label' => 'Udica — story 9:16'],
